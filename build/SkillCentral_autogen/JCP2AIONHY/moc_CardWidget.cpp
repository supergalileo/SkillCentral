...
#include "../../../include/ui/CardWidget.h"
...
template <> constexpr inline auto CardWidget::qt_create_metaobjectdata<qt_meta_tag_ZN10CardWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(int, int)>(6, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 5 }, { QMetaType::Int, 7 },
        }}),
        // Signal 'agentToggled'
        QtMocHelpers::SignalData<void(int, int, bool)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Int, 5 }, { QMetaType::Int, 9 }, { QMetaType::Bool, 10 },
        }}),
        // Slot 'onCardClicked'
        ...
        QtMocHelpers::SlotData<void(int, bool)>(12, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Int, 5 }, { QMetaType::Bool, 13 },
        }}),
        // Slot 'relayout'
...
void CardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->cardClicked((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->frequencyChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        ...
        case 4: _t->onCardClicked((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 5: _t->onCheckBoxToggled((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        case 6: _t->relayout(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CardWidget::*)(int )>(_a, &CardWidget::selectionChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (CardWidget::*)(int )>(_a, &CardWidget::cardClicked, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (CardWidget::*)(int , int )>(_a, &CardWidget::frequencyChanged, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (CardWidget::*)(int , int , bool )>(_a, &CardWidget::agentToggled, 3))
            return;
    }
}
...
// SIGNAL 0
void CardWidget::selectionChanged(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void CardWidget::cardClicked(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void CardWidget::frequencyChanged(int _t1, int _t2)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 2, nullptr, _t1, _t2);
}

// SIGNAL 3
void CardWidget::agentToggled(int _t1, int _t2, bool _t3)
{
